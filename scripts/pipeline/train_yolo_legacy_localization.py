...
# Same dataset for localization
DATASET_DIR = PROJECT_ROOT / "FracAtlas_Segmentor_Dataset"
YAML_PATH = DATASET_DIR / "data.yaml"

MODELS_DIR = PROJECT_ROOT / "models"
RUNS_DIR = PROJECT_ROOT / "runs" / "localize"

def train():

    print(f"Loading YOLOv8 Small Localizer")
    ...
    results = model.train(
        ...
        name="fracatlas_legacy_localization",
        epochs=30,
        imgsz=600,
        batch=16,
        seed=0,
    ...
    if best_weight_path.exists():
        target_path = MODELS_DIR / "localizer_legacy_best.pt"
